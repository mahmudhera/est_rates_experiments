...
def plot_estimated_rates(df, fixed_ps, fixed_pd, fixed_d, method_name, ax):
    ...
    sns.boxplot(x='true', y='est', hue='ksize', data=plot_df, ax=ax, linewidth=0.5)
...
def main():
    ...
    plot_estimated_rates(df, fixed_ps=0.01, fixed_pd=0.01, fixed_d=None, method_name=args.method, ax=axs[0][0])
    ...
    plot_estimated_rates(df, fixed_ps=None, fixed_pd=0.01, fixed_d=0.01, method_name=args.method, ax=axs[0][2])
    axs[0][2].set_title("$p_d = 0.01, d = 0.01$")
    
    plot_estimated_rates(df, fixed_ps=0.05, fixed_pd=0.05, fixed_d=None, method_name=args.method, ax=axs[1][0])
    ...
    plot_estimated_rates(df, fixed_ps=None, fixed_pd=0.05, fixed_d=0.05, method_name=args.method, ax=axs[1][2])
